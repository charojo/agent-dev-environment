...
# This resolves issues with browser security policies (CORS) when viewing Doxygen
# search features via `file://`.
#
# **Usage:**
...
def main():
    ...
    if not docs_gen_dir.exists():
        ...
        print(
            "Please run documentation generation first: "
            "uv run python agent_env/bin/ADE_document.py --pdf"
        )
        sys.exit(1)
